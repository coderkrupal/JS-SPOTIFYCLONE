...
let songs = [
    ...
    {songName: "Rabba - Salam-e-Ishq", filePath: "songs/2.mp3", coverPath: "./spotify/covers/6.jpg"},
    {songName: "Sakhiyaan - Salam-e-Ishq", filePath: "songs/2.mp3", coverPath: "./spotify/covers/7.jpg"},
    {songName: "Bhula Dena - Salam-e-Ishq", filePath: "songs/2.mp3", coverPath: "./spotify/songs/8.mp3"},
    {songName: "Tumhari Kasam - Salam-e-Ishq", filePath: "songs/2.mp3", coverPath: "./spotify/songs/9.mp3"},
    {songName: "Na Jaana - Salam-e-Ishq", filePath: "songs/4.mp3", coverPath: "./spotify/songs/10.mp3"},
]
...
document.getElementById('next').addEventListener('click', ()=>{
    ...
    audioElement.src = `/spotify/song/${songIndex+1}.mp3`;
    masterSongName.innerText = songs[songIndex].songName;
    audioElement.currentTime = 0;
    audioElement.play();
    masterPlay.classList.remove('fa-play-circle');
